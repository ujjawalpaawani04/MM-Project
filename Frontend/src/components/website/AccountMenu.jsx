      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-3 w-72 origin-top-right rounded-2xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 shadow-[0_20px_60px_rgba(15,23,42,0.18)] p-2 z-[1000]"
          >
            {/* Profile header */}
            <Link
              to="/account"
              ...
              className="flex items-center gap-3 rounded-xl p-3 hover:bg-brand-50 dark:hover:bg-slate-700/60 focus-visible:bg-brand-50 dark:focus-visible:bg-slate-700/60 focus-visible:outline-none transition-colors"
            >
              ...
              <div className="min-w-0">
                ...
                {verified && (
                  <span className="mt-1 inline-flex items-center gap-1 rounded-full bg-brand-50 dark:bg-brand-500/15 px-2 py-0.5 text-[10px] font-semibold text-brand-600 dark:text-brand-300">
                    Verified Account
                  </span>
                )}
              </div>
