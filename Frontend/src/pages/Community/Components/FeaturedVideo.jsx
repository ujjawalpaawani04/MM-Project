...
export default function FeaturedVideo({ video, onPlay }) {
  ...
  return (
    ...
    >
      ...
      <div className="group grid overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-[0_30px_80px_-40px_rgba(255,0,51,0.4)] transition-all duration-300 hover:border-red-200 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center gap-5 p-6 sm:p-8 lg:p-10">
          <span className="inline-flex w-fit items-center gap-1.5 text-xs font-medium text-gray-500">
            <FiClock size={14} /> {formatPublished(publishedAt)}
          </span>

          <h3
            className="text-xl font-extrabold leading-snug text-gray-900 sm:text-2xl lg:text-3xl"
            title={title}
          >
            {title}
          </h3>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-5 py-3 text-sm font-semibold text-gray-700 shadow-sm transition-all duration-200 hover:border-red-300 hover:text-red-600"
            >
