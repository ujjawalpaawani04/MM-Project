...
export default function VideoCardSkeleton() {
  return (
    <div className="flex h-full animate-pulse flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
      <div className="aspect-video w-full bg-gray-200 dark:bg-slate-700" />
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="mt-auto flex items-center justify-between pt-4">
          ...
          <div className="h-7 w-20 rounded-lg bg-gray-200 dark:bg-slate-700" />
        </div>
      </div>
    </div>
  );
